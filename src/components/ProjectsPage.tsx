...
export default function ProjectsPage({ projects }: ProjectsPageProps) {
  ...
  const { activeProjects } = useGitHubActivity(projects, 30);
              ...
              >
                ...
                <div className="mb-4">
                  <span className={`px-3 py-1 rounded-full text-sm font-bold border ${
                    selectedProject.status === 'completed' ? 'bg-green-900 text-green-300 border-green-600' :
                    selectedProject.status === 'in-progress' ? 'bg-yellow-900 text-yellow-300 border-yellow-600' :
          ...
          <div className="w-80 flex flex-col">
            {selectedProject && (
              <motion.div
                ...
                className="bg-black/60 backdrop-blur-sm rounded-lg p-6 flex-1 overflow-y-auto"
              >
                <h4 className="text-xl font-bold text-[#d4af37] mb-6">TECHNOLOGIES</h4>
                    ...
                    {selectedProject.jewelSlots
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <div className="font-semibold text-[#d4af37] text-sm">{slot.jewel}</div>
                        </div>
                      </motion.div>
                    ))}
                  </div>
