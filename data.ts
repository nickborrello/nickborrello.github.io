...
export const PROJECTS: ProjectItem[] = [
  {
    ...
    image: "/work/baystate-onboarding-review.png",
    imageAlt: "Bay State onboarding review board: vendor product cards moving through discovery, extraction, and human review stages with evidence states and batch progress.",
  ...
  },
  {
    ...
    image: "/work/resumancer-editor-copilot.png",
    imageAlt: "Resumancer workspace: tailored resume preview beside the agent copilot panel listing five pending, evidence-backed change proposals for review.",
    featured: true,
    startDate: "10-2025",
    endDate: "Present",
  },
