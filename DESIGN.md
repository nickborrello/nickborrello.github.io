...
**"Field terminal" — NieR as seasoning, not skin.** The portfolio uses the materials of the NieR: Automata universe — warm beige ground, charcoal ink, Rajdhani display headings, subtle machine-red accent — without heavy game-menu or meta-telemetry baggage. The page is a clean, modern, scrollable engineering document whose primary subject is production software and systems engineering.
...
- **Rajdhani** (500/600/700) — display headings, section labels, buttons, tech stack tags. Uppercase with tracking is reserved for short display strings.
- **Inter** (400/500/600) — body, summaries, case study highlights, experience bullets.
- Scale: display 2.5–5.25rem (hero title), section titles 2–2.5rem, body 0.9375–1.0625rem at comfortable reading measure.
