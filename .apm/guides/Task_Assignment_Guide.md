...
[Manager fills this section with section §7 content guidance, including explicit command references for Debug/Research delegations (.gemini/commands/apm-8-delegate-debug.toml or .gemini/commands/apm-7-delegate-research.toml)]
```
...
- **Debug Delegation**: Reference .gemini/commands/apm-8-delegate-debug.toml
- **Research Delegation**: Reference .gemini/commands/apm-7-delegate-research.toml  
