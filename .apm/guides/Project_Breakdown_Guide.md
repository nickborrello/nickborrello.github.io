...
**Content Definition:**
- If flagged in §4.1, first add an ad-hoc delegation step: "Ad-Hoc Delegation – <purpose>" (optional ref to .gemini/commands/apm-7-delegate-research.toml or .gemini/commands/apm-8-delegate-debug.toml), then continue
