...
const BookLayout: React.FC<BookLayoutProps> = ({ 
  ...
  return (
    <div className="w-full h-full flex items-center justify-center animate-fade-in relative z-10">
        ...
        <div className="relative w-[94vw] h-[98vh] flex shadow-[0_0_50px_rgba(0,0,0,0.8)] border-[8px] border-[#2a2824] bg-[url('/book.png')] bg-cover bg-center rounded-sm pt-20">
            ...
            {/* --- LEFT PAGE --- */}
            <div className="flex-1 relative flex flex-col pr-10 md:pr-16 mx-4 mb-4">
                {/* Page Texture */}
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/aged-paper.png')] opacity-60 pointer-events-none mix-blend-multiply"></div>
                 ...
                 {/* Content Container */}
                 <div className="relative z-10 flex-1 flex flex-col h-full" style={{ overflow: 'visible' }}>
                     {leftContent}
                 </div>
            ...
            {/* --- RIGHT PAGE --- */}
            <div className="flex-1 relative flex flex-col pl-10 md:pl-16 mx-4 mb-4">
                {/* Page Texture */}
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/aged-paper.png')] opacity-60 pointer-events-none mix-blend-multiply"></div>
