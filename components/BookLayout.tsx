...
const BookLayout: React.FC<BookLayoutProps> = ({ 
  ...
  return (
    <div className="w-full h-full flex items-center justify-center animate-fade-in relative z-10">
        ...
        <div className="relative w-[94vw] h-[98vh] flex shadow-[0_0_50px_rgba(0,0,0,0.8)] border-[8px] border-[#2a2824] bg-[#2a2824] rounded-sm overflow-hidden">
            
            {/* Spine Shadow - Darkest at center (crease), fading outward */}
            <div className="absolute left-1/2 top-0 bottom-0 w-24 -translate-x-1/2 z-20 bg-gradient-to-r from-transparent via-black/60 to-transparent pointer-events-none mix-blend-multiply"></div>
            ...
            {/* --- LEFT PAGE --- */}
            <div className="flex-1 relative bg-[#eaddcf] flex flex-col overflow-hidden pr-2 md:pr-10">
                {/* Page Texture */}
                ...
                {/* Content Container */}
                <div className="relative z-10 flex-1 flex flex-col overflow-y-auto h-full pr-2">
                    {leftContent}
                </div>

                {/* Left Page Footer (Controls) */}
                <div className="relative z-20 p-4 border-t border-[#8c8574]/30 flex items-center gap-4 mt-auto bg-[#eaddcf]/90 backdrop-blur-sm">
                   <button 
                      onClick={onBack}
            ...
            {/* --- RIGHT PAGE --- */}
            <div className="flex-1 relative bg-[#eaddcf] flex flex-col overflow-hidden pl-10 md:pl-16">
                {/* Page Texture */}
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/aged-paper.png')] opacity-60 pointer-events-none mix-blend-multiply"></div>
