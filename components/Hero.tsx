...
export const Hero: React.FC = () => {
  return (
    <section aria-label="Introduction" className="mesh relative">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-16 pb-16 sm:pt-24 sm:pb-24 flex flex-col">
        {/* Status line */}
        ...
        {/* Name */}
        <h1
          className="rise-in mt-6 font-tech font-bold text-nier-darker leading-[0.95] tracking-[0.01em] text-[clamp(2.75rem,10vw,5.5rem)]"
        ...
        {/* Role & Positioning */}
        <div className="rise-in mt-3 sm:mt-4 flex flex-wrap items-baseline gap-x-3 gap-y-1" style={{ animationDelay: '120ms' }}>
          <span className="font-tech font-semibold tracking-[0.26em] text-base sm:text-xl text-accent uppercase">
            {USER_INFO.title}
          </span>
          <span aria-hidden="true" className="hidden sm:inline text-nier-dark/40">/</span>
          <span className="font-tech font-medium tracking-[0.16em] text-sm sm:text-base text-nier-dark uppercase">
        ...
        {/* Summary */}
        <p
          className="rise-in mt-6 max-w-2xl text-[16px] sm:text-[17px] leading-relaxed text-nier-dark/90"
