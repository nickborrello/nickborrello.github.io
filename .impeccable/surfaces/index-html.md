...
- Three visual case studies: Resumancer (live screenshots from resumancer.dev in public/work/), Bay State AI Data Pipeline (authored mock-data onboarding console — pipeline is private), ShopSite-MCP (authored MCP architecture diagram — repo private).
